...
def get_rate(Country,CurrencyFrom,CurrencyTo,Date):
	...
	if Country == 'KZ' and CurrencyFrom == 'KZT' and CurrencyTo == 'USD':
		r = requests.post('https://www.nationalbank.kz/?docid=362&switch=english', data={'docid': '362', 'eDate': Date[-2:]+ '/' + Date[5:7] + '/' + Date[:4], 'flag': '1', 'idval': '5','OK2': 'Show report', 'sDate': Date[-2:]+ '/' + Date[5:7] + '/' + Date[:4]}, verify=False)			
